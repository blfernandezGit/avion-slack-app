    ...
    return (
        ...
        {!search && !chat && 
            <div className="relative m-1 flex flex-col">
                ...
                <input required className="bg-transparent text-center text-white md:w-80 md:m-2 border-b-2 border-white focus:outline-none focus:border-pink rounded-md" type={type} placeholder={placeholder} ref={reference}></input>
            </div>
        }
        {search &&
