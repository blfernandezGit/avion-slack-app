...
const Hamburger = () => {
    ...
    return (
        <svg onClick={() => handleShowMenu()}id="light" height="32" viewBox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg" className="fill-current text-white hover:text-pink ml-2 md:ml-4">
            <g>
